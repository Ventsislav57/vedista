...
export default function NotFound() {
  return (
    <section className="grain relative flex min-h-[70vh] items-center overflow-hidden bg-gradient-to-b from-forest-950 to-forest-800 px-5 py-32 text-center text-cream sm:px-8">
      ...
      <div className="relative z-10 mx-auto flex max-w-lg flex-col items-center">
        ...
        <div className="mt-9 flex flex-wrap items-center justify-center gap-4">
          <Link
            href="/"
            className="group flex items-center gap-2 rounded-full bg-wheat-500 px-7 py-3.5 text-sm font-semibold text-forest-950 transition-transform duration-300 hover:-translate-y-0.5"
          >
            Начало
